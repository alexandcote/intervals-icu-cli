...
export const DEFAULT_FIELDS = {
  ...
  /** Per-interval fields for `activities get --intervals` (raw objects carry ~84 fields each). */
  activityInterval: [
    'type',
    'label',
    'start_time',
  ...
  /** Per-group fields (repeated efforts, e.g. "4x 7m") for `activities get --intervals`. */
  activityIntervalGroup: ['id', 'count', 'moving_time', 'average_watts', 'average_heartrate', 'average_cadence', 'average_speed'],
  athlete: [
    'id',
    'name',
    'profile_medium',
